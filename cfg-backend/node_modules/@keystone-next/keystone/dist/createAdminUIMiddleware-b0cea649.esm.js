...
import { a as createApolloServerExpress } from './createApolloServer-c5812228.esm.js';
import url from 'url';
...
const addApolloServer = async ({
  ...
  apolloServer.applyMiddleware({
    ...
    cors: ((_config$graphql2 = config.graphql) === null || _config$graphql2 === void 0 ? void 0 : _config$graphql2.cors) || (process.env.NODE_ENV !== 'production' ? {
...
const createExpressServer = async (config, graphQLSchema, createContext) => {
  ...
  if ((_config$server3 = config.server) !== null && _config$server3 !== void 0 && _config$server3.extendExpressApp) {
    ...
    (_config$server4 = config.server) === null || _config$server4 === void 0 ? void 0 : _config$server4.extendExpressApp(server, createRequestContext);
  }
...
const adminErrorHTMLFilepath = Path__default.join(Path__default.dirname(require.resolve('@keystone-next/keystone/package.json')), 'static', 'admin-error.html');
