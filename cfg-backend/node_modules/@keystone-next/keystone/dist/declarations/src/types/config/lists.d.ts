...
export declare type ListConfig<TGeneratedListTypes extends BaseGeneratedListTypes, Fields extends BaseFields<TGeneratedListTypes>> = {
     ...
     */
    description?: string;
    defaultIsFilterable?: false | ((args: FilterOrderArgs) => MaybePromise<boolean>);
    defaultIsOrderable?: false | ((args: FilterOrderArgs) => MaybePromise<boolean>);
};
