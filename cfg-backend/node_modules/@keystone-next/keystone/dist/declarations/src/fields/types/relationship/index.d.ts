...
export declare type RelationshipFieldConfig<TGeneratedListTypes extends BaseGeneratedListTypes> = CommonFieldConfig<TGeneratedListTypes> & {
    many?: boolean;
    ref: string;
    ui?: {
        hideCreate?: boolean;
...
export declare const relationship: <TGeneratedListTypes extends BaseGeneratedListTypes>({ many, ref, ...config }: RelationshipFieldConfig<TGeneratedListTypes>) => FieldTypeFunc;
export {};
