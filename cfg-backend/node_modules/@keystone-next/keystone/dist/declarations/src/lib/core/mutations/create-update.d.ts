...
}, list: InitialisedList, context: KeystoneContext): Promise<ItemRootValue>;
export declare function createMany(createInputs: {
    data: Record<string, any>[];
}, list: InitialisedList, context: KeystoneContext, provider: DatabaseProvider): Promise<Promise<ItemRootValue>[]>;
