...
import { FindManyArgsValue, ItemRootValue, KeystoneContext } from '../../../types';
import { PrismaFilter, UniquePrismaFilter, UniqueInputFilter, InputFilter } from '../where-inputs';
import { InitialisedList } from '../types-for-lists';
export declare function mapUniqueWhereToWhere(list: InitialisedList, uniqueWhere: UniquePrismaFilter): PrismaFilter;
...
}, list: InitialisedList, context: KeystoneContext): Promise<ItemRootValue | null>;
export declare function findMany({ where, take, skip, orderBy: rawOrderBy }: FindManyArgsValue, list: InitialisedList, context: KeystoneContext, info: GraphQLResolveInfo, extraFilter?: PrismaFilter): Promise<ItemRootValue[]>;
