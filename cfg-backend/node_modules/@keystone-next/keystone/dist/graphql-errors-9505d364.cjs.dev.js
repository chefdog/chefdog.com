...
const userInputError = msg => new apolloServerErrors.ApolloError(`Input error: ${msg}`);
const accessDeniedError = msg => new apolloServerErrors.ApolloError(`Access denied: ${msg}`);
...
const filterAccessError = ({
  operation,
  fieldKeys
}) => new apolloServerErrors.ApolloError(`You do not have access to perform '${operation}' operations on the fields ${JSON.stringify(fieldKeys)}.`);
