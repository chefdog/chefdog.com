...
var createApolloServer = require('./createApolloServer-1b8db11a.cjs.prod.js');
var url = require('url');
...
const addApolloServer = async ({
  ...
  apolloServer.applyMiddleware({
    ...
    cors: ((_config$graphql2 = config.graphql) === null || _config$graphql2 === void 0 ? void 0 : _config$graphql2.cors) || (undefined)
  });
};
