...
require('../../../../../dist/getRootGraphQLFieldsFromFieldController-47699a0d.cjs.dev.js');
var useInvalidFields = require('../../../../../dist/useInvalidFields-162d1b9c.cjs.dev.js');
var client = require('@apollo/client');
var adminUi_context_dist_keystone = require('../../../../../admin-ui/context/dist/keystone.cjs.dev.js');
var PageContainer = require('../../../../../dist/PageContainer-af120db9.cjs.dev.js');
var GraphQLErrorNotice = require('../../../../../dist/GraphQLErrorNotice-76ff96dd.cjs.dev.js');
...
const ItemPage = ({
  ...
  const {
    ...
    let selectedFields = Object.entries(list.fields).filter(([fieldKey, field]) => field.itemView.fieldMode !== 'hidden' || // the id field is hidden but we still need to fetch it
    fieldKey === 'id').map(([fieldKey]) => {
